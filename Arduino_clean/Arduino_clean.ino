...
#define ENTRY_TIME_LIMIT   6000 //Amount of time to press a button before game times out. 
...

{
   ...
   char data = Serial.read();// indiacte the input from the kinect camera 
   if(data=='Y') {
    Serial.println(" got into a ") ;
    return(CHOICE_RED); 
   }
   if(data=='B') {
    Serial.println(" got into B ") ;
...
//        Serial.println(" CLICK ON RED ") ;
//        return(CHOICE_RED); 
//    }
//    if (digitalRead(BUTTON_GREEN) == 0){
//      Serial.println("CHLICK ON GREEN  ") ;
//      return(CHOICE_GREEN); 
//    }
//    if (digitalRead(BUTTON_BLUE) == 0){
//      Serial.println("CHLICK ON BLUE  ") ;
//      return(CHOICE_BLUE); 
//    }
//
//   else if (digitalRead(BUTTON_YELLOW) == 0){
//    Serial.println("CHLICK ON YELLOW  ") ;
//    return(CHOICE_YELLOW);
//   }
//  Serial.println("CHOICE_NONE  ") ;
